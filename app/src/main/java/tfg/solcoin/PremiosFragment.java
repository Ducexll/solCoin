...
public class PremiosFragment extends Fragment {
    ...
    private static final String URL_PREMIOS = "http://192.168.83.201:80/developjulio/selecPremios.php";
    ...
    private void restarSaldo(double precio) {
        ...
        String URL_OBTENER_SALDO = "http://192.168.83.201:80/developjulio/consultarSaldo.php";
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (jsonObject.has("saldo")) {
                                ...
                                String URL_MODIFICAR_SALDO = "http://192.168.83.201:80/developjulio/modificarSaldo.php";
